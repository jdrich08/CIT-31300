...
<div class="container">
  ...
  <div class="row">
      <div class="span8">
        <form action="<?php echo BASE_URL?>manageposts/<?php echo $task?>" id="add_post_form" method="post" onsubmit="editor.post()">
          <label>Title</label>
          <input type="text" class="span6" id="title" name="title" value="<?php echo $title?>" required="title">
